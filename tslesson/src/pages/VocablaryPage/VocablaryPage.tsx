// import Left from '../../assets/images/header/Left.svg'
...
//   return (
//     <div className='vocablarypage'>
     
// <div className="vocablarypage_top">
//     <div className="vocablary__left">
//         <img src={Left} alt="" />
//     </div>
 
// </div>

// <TableComponent title="Vocabulary">
//                 <TableBody>
